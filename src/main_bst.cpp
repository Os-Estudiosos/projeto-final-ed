...
int main(int argc, char* argv[])
{
    ...
    if (command_type == "search") {
        ...
        std::ofstream InsertingStats(pathStats.string() + "bst/bstInsertStats_"+ std::to_string(n_docs)+"archives.csv");
        ...
        std::ofstream SearchingStats(pathStats.string() + "bst/bstSearchStats_"+std::to_string(n_docs)+"archives.csv");
